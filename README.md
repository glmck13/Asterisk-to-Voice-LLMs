...
+ Raspberry Pi 4B, Debian 12, Asterisk 20.7.0, FreePBX 17.0.28 (Google model only since Python 3.11)
+ Vultr cloud server, Debian 12, Asterisk 22.5.2, FreePBX 17.0.28, (Python3.13 compiled separately to invoke AWS API)
